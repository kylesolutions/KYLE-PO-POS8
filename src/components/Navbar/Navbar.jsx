...
function Navbar() {
    ...
    const handleLogout = async () => {
        try {
            ...
            // Check the nested status in the message object
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <div className="navbar-nav mx-auto text-center">
                                ...
                                <a className="nav-link active text-black cursor-pointer" onClick={() => navigate('/')}>
                                    <i className="bi bi-menu-button-wide fs-2"></i>
                                </a>
                                <a className="nav-link active text-black cursor-pointer" onClick={() => navigate('/table')}>
